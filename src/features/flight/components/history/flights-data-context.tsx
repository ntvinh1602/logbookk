...
import { useFlightsFilters } from '@/features/flight/hooks/use-flights-filters'
import { useDeleteFlight } from '@/features/flight/hooks/use-delete-flight'
import { useInfiniteQuery } from '@/hooks/use-infinite-query'
import type { Flight } from '@/features/flight/ui/flight-item'
...
export function useFlightsData() {
  ...
  if (!ctx) {
    throw new Error('useFlightsData must be used within FlightsDataProvider')
  }
  return ctx
}
